...
import { changelocation } from "../../actions/travel";
    ...
    render() {
        ...
        return (
            <View className="searchPage">
                <NavBar key={"searchLocalPage"} title="马蜂窝" showLeft={true}/>
                <View className="searchWrap">
                    <View className="searchView">
                        <View className="iconfont iconsearch"/>
                        <Input type='text' placeholder='找不到位置？点这里搜搜看～' className="searchText" focus={true} onInput={this.onInput}/>
                    </View>
