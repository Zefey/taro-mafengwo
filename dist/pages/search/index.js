...
__webpack_require__(/*! ./index.scss */ "./src/pages/search/index.scss");
...
var Search = (_dec = (0, _redux.connect)(function (_ref) {
  ...
  function Search() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = Search.__proto__ || Object.getPrototypeOf(Search)).call.apply(_ref2, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "loopArray8", "$compid__10", "result", "data", "update", "user"], _this.state = {
      data: [],
      result: []
  ...
  _createClass(Search, [{
    ...
    value: function _createData() {
      ...
      var anonymousState__temp = "searchPage";
      var loopArray8 = result.map(function (item, index) {
        item = {
  ...
  return Search;
}(_taroWeapp.Component), _class2.$$events = ["onInput", "cancel", "anonymousFunc0"], _class2.$$componentPath = "pages/search/index", _temp2)) || _class);
...
},[["./src/pages/search/index.jsx","runtime","vendors"]]]);